...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	make_shared<MagicVariableDeclaration>("funtest", make_shared<FunctionType>(strings{"bytes32", "uint256", "bytes32"}, strings{"uint256"}, FunctionType::Kind::Funtest,false, StateMutability::Pure)),
